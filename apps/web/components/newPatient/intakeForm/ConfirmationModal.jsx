...
اوس دا کړکۍ بندولی شئ.`
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" style={{ overflowY: 'auto', height: '100vh', paddingTop: '40vh' }}>
            <div className="bg-white p-6 rounded shadow-lg max-w-xl pt-72">
                {submittingFromNoSession ? (
                    <>
                        <h2 className="text-2xl text-green-700 font-bold mb-4 text-center border-b-2 pb-4 rounded-xl border-r-2 border-l-2 border-green-900 shadow-[0_48px_72px_rgba(34,197,94,0.33)]">{values.newPatientRequest[language]}</h2>
                        <br/>
                        ...
                        <br/>
                        <h2 className="rounded-xl text-xl text-center bg-darkBlue text-green-100 p-2 m-2 font-bold mb-4 shadow-[0_12px_16px_rgba(34,197,94,0.33)]">{values.registrationConditions[language]} </h2>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center mt-8 space-y-4 sm:space-y-0 sm:space-x-6 pb-16">

                            <Button
                                variant={'close'}
                                className="w-full sm:w-auto text-xl px-6 py-3 bg-white text-green-700 border-2 border-green-700 rounded-lg hover:bg-green-700 transition-colors duration-300"
                                onClick={() => {
                                    onClose();
                                }}
                            >
