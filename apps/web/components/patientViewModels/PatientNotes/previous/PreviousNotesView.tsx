...
interface PreviousNotesViewProps {
    ...
    setTemplateType: Dispatch<SetStateAction<"subjective" | "physician" | "procedure" | "blank">>
                                ...
                                >
                                    ...
                                    {expandedNotes.includes(note._id) && (
                                        <div className="mt-2">
                                            ...
                                            {note.noteType === 'blank' && note.content && (
                                                <>
                                                    <p><strong>Content:</strong> {note.content.noteField}</p>
                                                </>
                                            )}
                                        </div>
                                    )}
