...
import { BlankNoteView } from "./forms/BlankNoteView";
                    ...
                    <Card className="flex-grow h-full md:h-auto overflow-hidden">
                        <CardHeader className="px-4 py-2">
                            ...
                            >
                                ...
                                <RadioCard.Item
                                    value="blank"
                                    className={`flex-1 ${templateType === 'blank' ? 'border-2 border-orange-500' : 'border border-gray-200'}`}
                                >
                                    Blank
                                </RadioCard.Item>
                            </RadioCard.Root>
                        ...
                        <CardContent className="h-full md:h-[calc(100vh-120px)] p-0">
                            <ScrollArea className="h-full w-full pb-16">
                                <div className="mt-4 p-4">
                                    ...
                                    {templateType === 'blank' && (
                                        isLoading ? (
                                            <ReadOnlyField fieldName="blank" fieldLabel="Blank Note" value={JSON.stringify(blankNote)} />
                                        ) : (
                                            <BlankNoteView
                                                note={blankNote}
                                                onChange={(name, value) => setNoteField('blank', name, value)}
                                            />
                                        )
                                    )}
                                    <Button
