// components/patientViewModels/Medications/rx/RXOrderView.tsx
'use client'
    ...
    return (
        <ToastProvider>
            <div className="space-y-6 max-w-2xl mx-auto bg-orange-950 p-4">
                <fieldset className="border rounded-lg bg-white shadow-sm object-center justify-center center -ml-2">
                    ...
                    <div className="space-y-4 text-darkBlue">
                        ...
                        <TextFormField
                            ...
                            readOnly={true}
                            className={'pb-4 rounded-2xl border-b-2 border-darkBlue'}
                        />
                        <TextFormField
                            ...
                            readOnly={true}
                            className={'text-orange-950 pt-4 rounded-2xl border-t-2 border-orange-950'}
                        />
                        <TextFormField
                            fieldName="city"
                    ...
                    <div
                        className="space-y-4 flex flex-col items-center justify-center text-center border-4 bg-orange-950 border-white rounded-3xl p-4">
                ...
                <div className="space-y-6 max-w-2xl mx-auto bg-orange-950">
                    <Button
                        ...
                        className="w-full bg-orange-950 hover:bg-orange-700 active:bg-orange-600"
                        variant="submit"
                    >
                        {isLoading ? (
                            <ClipLoader size={24} color={orange300} loading={isLoading} />
                        ) : (
                            "Submit Medication Prescription Referral"
                        )}
                    </Button>
                </div>
            </div>
