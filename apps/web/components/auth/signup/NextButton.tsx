// components/auth/signup/NextButton.tsx
'use client';

import React, { useState } from 'react'
import { Button } from "@/components/ui/button"
import { Send } from "lucide-react";
import { useSignupContext } from "@/components/auth/signup/SignupContext"
...
export default function NextButton() {
    ...
    const isCurrentStepComplete = () => {
        ...
        if (currentStep === 1) return stepAnswers[currentStep] === getTotalRequiredFieldsForStep(currentStep) && passwordsMatch && agreedToTerms
  ...
  ${canProceed && !loading
                ? 'bg-white text-orange-500 shadow-lg shadow-orange-50 border-2 border-orange-200 hover:bg-orange-500 hover:text-white hover:shadow-orange-200'
                : 'bg-white text-orange-200 border-2 border-orange-200 hover:text-orange-700 hover:bg-transparent'
            }`}
        >
            {loading ? (
