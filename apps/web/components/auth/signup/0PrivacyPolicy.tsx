    ...
    return (
        <div className="container mx-auto py-8 px-4">
            <Card className="max-w-3xl mx-auto">
                <CardHeader>
                    <CardTitle className="text-3xl font-bold text-center bg-orange-100 text-darkBlue pb-2 border-b-2 border-orange-500"><u>Doctors, Triage Coordinators, and Evacuations Privacy Policy</u></CardTitle>
                </CardHeader>
                <CardContent>
                    <ScrollArea className="h-[70vh] pr-4">
                        <div className="space-y-6">
                            <p className="text-xl text-gray-500 text-center"><i>Last updated: <u>January 14,
                                2025</u></i></p>
