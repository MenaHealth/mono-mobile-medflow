...
export function NewPatientFormTelegramView({
    ...
    const fieldLabels = {
        ...
        chiefComplaint: { English: "What is your medical complaint? please provide details.", Arabic: "ما هي مشكلتك الطبية؟ يرجى تقديم التفاصيل.", Farsi: "مشکل پزشکی شما چیست؟ لطفاً جزئیات را ارائه دهید.", Pashto: "Pashto: ستاسو طبي ستونزه څه ده؟ مهرباني وکړئ تفصيلات وړاندې کړئ." },
        genderPreference: {
